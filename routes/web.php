...
Route::resource('/painel/clientes', 'ClientesController');
Route::resource('/painel/produtos', 'ProdutosController');
Route::resource('/painel/vendas', 'VendasController');
Route::resource('/painel/relatorios', 'RelatoriosController');
